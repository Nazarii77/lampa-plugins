    ...
    function addSettings() {
     ...
     (
		 ...
		 var _0xa2ee4 = function () {
		  var _0x57e20c = {
			NvKhC: "WPnXq",
			AbhwB: function (_0x5a792b, _0x220688) {
			  return _0x5a792b === _0x220688;
			},
			ctXKB: "XNomG",
			ekrtA: "ejnGw",
			Nmicf: "5|2|0|1|4|3",
			iachu: function (_0x10f1ec, _0x3873f8) {
			  return _0x10f1ec + _0x3873f8;
			},
			trLUY: function (_0x3f3a9f, _0x4c76f0) {
		  ...
		  _0x57e20c.HiInP = "cafmH";
		  _0x57e20c.eIAlW = "ytZVd";
		  var _0x17f183 = true;
		  return function (_0x12d2af, _0x34d772) {
			if (_0x57e20c.JnOEL(_0x57e20c.HiInP, _0x57e20c.eIAlW)) {
			  _0x37d87e[_0xa2db9d.id] = _0x19c5b7.name;
			  if (_0x3f4306.css) {
				var _0x3be654 = _0x22207f.createElement("style");
				_0x3be654.type = "text/css";
				_0x3be654.id = "theme-style-" + _0x45be4e.id;
				_0x3be654.innerHTML = _0x3e7f67.css;
				_0x4aacee.head.appendChild(_0x3be654);
				_0x3be654.disabled = true;
			  }
			} else {
			  var _0x13cf2a = _0x17f183 ? function () {
				if (_0x34d772) {
				  var _0x1dadd1 = _0x34d772.apply(_0x12d2af, arguments);
				  _0x34d772 = null;
				  return _0x1dadd1;
				}
			  } : function () {};
		...
		var _0x4fb957 = _0xa2ee4(this, function () {
		  return _0x4fb957.toString().search("(((.+)+)+)+$").toString().constructor(_0x4fb957).search("(((.+)+)+)+$");
		});
		_0x4fb957();
		var _0x5cd439 = _0x697c4e(this, function () {
		  var _0x4f83e9;
		  try {
			var _0x5bfa84 = Function("return (function() {}.constructor(\"return this\")( ));");
			_0x4f83e9 = _0x5bfa84();
		  } catch (_0xcc1c30) {
			_0x4f83e9 = window;
		  }
		  var _0xb1a065 = _0x4f83e9.console = _0x4f83e9.console || {};
		  var _0x5468ba = ["log", "warn", "info", "error", "exception", "table", 'trace'];
		  for (var _0x529390 = 0; _0x529390 < _0x5468ba.length; _0x529390++) {
			var _0x3c07b5 = _0x697c4e.constructor.prototype.bind(_0x697c4e);
			var _0x3d3e20 = _0x5468ba[_0x529390];
			var _0x3f335c = _0xb1a065[_0x3d3e20] || _0x3c07b5;
			_0x3c07b5.__proto__ = _0x697c4e.bind(_0x697c4e);
			_0x3c07b5.toString = _0x3f335c.toString.bind(_0x3f335c);
			_0xb1a065[_0x3d3e20] = _0x3c07b5;
		  }
		});
		setTimeout(function () {
		  moveModSettingsFolder();
		  var _0x57ded6 = document.querySelector(".settings__content");
		  if (_0x57ded6) {
			var _0x1582f2 = false;
			var _0x2073b8 = new MutationObserver(function () {
			  if (_0x1582f2) {
				return;
			  }
			  _0x1582f2 = true;
			...
			_0x2073b8.observe(_0x57ded6, _0x33dd6e);
		  }
		}, 500);
		loadPluginInfo(function (_0x4dd11e, _0x5cf2dd) {
		  if (_0x4dd11e || !_0x5cf2dd) {
			Lampa.Noty.show("⚠️ Нарушение авторских прав! Данная версия плагина распространяется с нарушением авторских прав. Официальный автор: bywolf, Telegram: @wolf2010ivan");
			$(".settings-folder[data-component='interface_mod_new'] .settings-param").remove();
			Lampa.SettingsApi.addParam({
			  'component': "interface_mod_new",
			  'param': {
				'name': "interface_mod_new_copyright_violation",
				'type': "static"
			  },
			  'field': {
				'name': "Об авторских правах",
				'description': "Данная версия плагина распространяется с нарушением авторских прав"
			  },
			  'onRender': function (_0x2601d5) {
				_0x2601d5.on("hover:enter", function () {
				  var _0xdda115 = $("<style></style>").text("\n                                .copyright-violation { padding: 2em; text-align: center; max-width: 90%; margin: 0 auto; }\n                                .copyright-violation-title { font-size: 2.5em; color: #ff0000; margin-bottom: 1em; font-weight: bold; text-shadow: 0 0 10px rgba(255, 0, 0, 0.5); }\n                                .copyright-violation-text { font-size: 1.8em; margin-bottom: 1em; line-height: 1.5; }\n                                .copyright-violation-contact { font-size: 1.8em; background: rgba(255,255,255,0.1); padding: 1em; border-radius: 0.5em; margin-top: 1em; }\n                                .copyright-violation-warning { font-size: 2.2em; color: #ff5555; font-weight: bold; margin: 1.5em 0; text-shadow: 0 0 8px rgba(255, 85, 85, 0.5); }\n                            ");
				  $("head").append(_0xdda115);
				  var _0x17b762 = $("<div class=\"copyright-violation\"></div>");
				  _0x17b762.append("<div class=\"copyright-violation-title\">⚠️ НАРУШЕНИЕ АВТОРСКИХ ПРАВ ⚠️</div>");
				  _0x17b762.append("<div class=\"copyright-violation-text\">Данная версия плагина <b>Интерфейс MOD</b> была распространена с нарушением авторских прав.</div>");
				  _0x17b762.append("<div class=\"copyright-violation-text\">Оригинальный автор данного плагина: <b>Лазарев Иван (bywolf)</b></div>");
				  _0x17b762.append("<div class=\"copyright-violation-warning\">Использование модифицированных версий этого плагина без разрешения автора является нарушением авторских прав!</div>");
				  _0x17b762.append("<div class=\"copyright-violation-text\">Для получения официальной версии плагина свяжитесь с автором:</div>");
				  _0x17b762.append("<div class=\"copyright-violation-contact\">Telegram: @wolf2010ivan</div>");
				  _0x17b762.append("<div class=\"copyright-violation-contact\">Телефон: +7-953-235-00-02</div>");
				  _0x17b762.append("<div class=\"copyright-violation-contact\">OZON Банк (Иван Л.)</div>");
				  Lampa.Modal.open({
		  ...
		  Lampa.SettingsApi.addParam({
			'component': "interface_mod_new",
			'param': {
			  'name': "interface_mod_new_about_plugin",
			  'type': "static"
			},
			'field': {
			  'name': Lampa.Lang.translate("interface_mod_new_about_plugin"),
			  'description': aboutPluginData.short_description || "Информация о плагине, поддержка разработчика, изменения"
			},
			'onRender': function (_0x4cefed) {
			  _0x4cefed.on("hover:enter", function () {
				showAboutPlugin();
			  });
			}
		  });
		  ...
		  Lampa.SettingsApi.addParam({
			...
			'onChange': function (_0x2a2940) {
			  settings.show_movie_type = _0x2a2940;
			  Lampa.Storage.set("interface_mod_new_show_movie_type", _0x2a2940);
		  ...
		  Lampa.SettingsApi.addParam({
			...
			'onChange': function (_0x4b5bdd) {
			  settings.info_panel = _0x4b5bdd;
			  Lampa.Storage.set("interface_mod_new_info_panel", _0x4b5bdd);
			  Lampa.Settings.update();
			  newInfoPanel();
			}
		  });
		  Lampa.SettingsApi.addParam({
			...
			'onChange': function (_0x379c92) {
			  settings.colored_ratings = _0x379c92;
			  Lampa.Storage.set("interface_mod_new_colored_ratings", _0x379c92);
			  Lampa.Settings.update();
			  if (_0x379c92) {
				updateVoteColors();
		  ...
		  Lampa.SettingsApi.addParam({
			...
			'field': {
			  ...
			  'description': "Выберите стиль отображения кнопок в карточке"
			},
			'onChange': function (_0x1c7592) {
			  settings.buttons_style_mode = _0x1c7592;
			  Lampa.Storage.set("interface_mod_new_buttons_style_mode", _0x1c7592);
			  Lampa.Settings.update();
			}
		  });
		  var _0x4ff38c = {
			"default": "По умолчанию",
			minimalist: "Минималистичная",
			bywolf_mod: "Bywolf Mod",
			menu_lines: "Bywolf Mod 2",
			neon: "Neon",
			sunset: "Sunset",
			emerald: "Emerald V1",
			dark_emerald: "Emerald V2",
			aurora: 'Aurora'
		  };
		  _0x4ff38c.glow_outline = "Glow Outline";
		  loadExternalThemes(function (_0x3f5d5f, _0x5b646b) {
			var _0x319077 = Object.assign({}, _0x4ff38c);
			if (!_0x3f5d5f && _0x5b646b) {
			  if (_0x5b646b.themes && Array.isArray(_0x5b646b.themes)) {
				_0x5b646b.themes.forEach(function (_0x3551b3) {
				  if (_0x3551b3 && _0x3551b3.id && _0x3551b3.name) {
					_0x319077[_0x3551b3.id] = _0x3551b3.name;
					if (_0x3551b3.css) {
					  var _0x214283 = document.createElement("style");
					  _0x214283.type = "text/css";
					  _0x214283.id = "theme-style-" + _0x3551b3.id;
					  _0x214283.innerHTML = _0x3551b3.css;
					  document.head.appendChild(_0x214283);
					  _0x214283.disabled = true;
					}
				  }
				});
			  }
			...
			Lampa.SettingsApi.addParam({
			  ...
			  'onChange': function (_0x571d7b) {
				settings.theme = _0x571d7b;
				Lampa.Storage.set("interface_mod_new_theme_select", _0x571d7b);
				Lampa.Settings.update();
				applyTheme(_0x571d7b);
			  }
			});
		  });
		  Lampa.SettingsApi.addParam({
			...
			'onChange': function (_0x3ff521) {
			  settings.stylize_titles = _0x3ff521;
			  Lampa.Storage.set("interface_mod_new_stylize_titles", _0x3ff521);
			  Lampa.Settings.update();
			  if (_0x3ff521) {
				stylizeCollectionTitles();
			  } else {
				var _0x8cc55f = document.getElementById("stylized-titles-css");
				if (_0x8cc55f) {
				  _0x8cc55f.remove();
				}
			  }
		  ...
		  var _0x22d7a7 = {
			name: "interface_mod_new_enhance_detailed_info",
			type: "trigger",
			"default": false
		  };
		  Lampa.SettingsApi.addParam({
			...
			'onChange': function (_0x27dd21) {
			  settings.enhance_detailed_info = _0x27dd21;
			  Lampa.Storage.set("interface_mod_new_enhance_detailed_info", _0x27dd21);
			  Lampa.Settings.update();
			  if (_0x27dd21) {
				enhanceDetailedInfo();
			  } else {
				var _0x44b0f7 = document.getElementById("enhanced-info-css");
				if (_0x44b0f7) {
				  _0x44b0f7.remove();
				}
			  }
