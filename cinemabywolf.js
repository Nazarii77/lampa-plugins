(function () {
    ...
    function addSettingsComponent() {
        ...
        // Показывать RU кінотеатри на главной
        Lampa.SettingsApi.addParam({
            component: 'cinemabywolf',
            param: { name: 'show_ru', type: 'trigger', default: CinemaByWolf.settings.show_ru },
            field: { name: 'Показывать RU кінотеатри на главной' },
        ...
        // Показывать EN кінотеатри на главной
        Lampa.SettingsApi.addParam({
            component: 'cinemabywolf',
            param: { name: 'show_en', type: 'trigger', default: CinemaByWolf.settings.show_en },
            field: { name: 'Показывать EN кінотеатри на главной' },
            onChange: function(val) {
                if (CinemaByWolf.debug) {
        ...
        // Показывать UA кінотеатри на главной
        Lampa.SettingsApi.addParam({
            component: 'cinemabywolf',
            param: { name: 'show_ua', type: 'trigger', default: CinemaByWolf.settings.show_ua },
            field: { name: 'Показывать UA кінотеатри на главной' },
            onChange: function(val) {
                if (CinemaByWolf.debug) {
